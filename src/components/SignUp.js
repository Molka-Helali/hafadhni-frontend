...
const SignUp = () => {
  ...
  return (
    ...
    <div className="Signup-form">
         ...
         <p className="Signup-title2">Follow the instructions to make it easier to register and you will be  able to explore inside.
          </p>
         <form className="Signup-input-container">
           ...
           <button type="submit" className="login-buttonSignup">Create Account</button>
         
            <div className="social-buttongoogle">Google 
            ...
            <div className="Log" >
            <span>Do you have account? </span> {/* Corrected spacing */}
      <a href="#" onClick={handleSignUpClick}>Login </a>
    </div>
         </form>
       </div>
    </div>
